...
class _PlayerScreenState extends State<PlayerScreen> {
  ...
  String? _activeMenu; // speed | quality | audio | sub
  ...
  Future<void> _initPlayer() async {
    try {
      _vpc = VideoPlayerController.networkUrl(Uri.parse(widget.streamUrl));
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          _MenuBtn(
                            ...
                            onTap: () => setState(() =>
                                _activeMenu = _activeMenu == 'speed'
                                    ? null
                                    : 'speed'),
                            menu: _activeMenu == 'speed'
                                ? _PopupMenu(
                                    items: const ['0.5x', '0.75x', '1.0x', '1.25x', '1.5x', '2.0x'],
                                    active: '${_playbackSpeed}x',
                                    onSelect: (v) {
                                      final spd = double.parse(
                                          v.replaceAll('x', ''));
                                      setState(() {
                                        _playbackSpeed = spd;
                                        _activeMenu = null;
                          ...
                          _MenuBtn(
                            ...
                            onTap: () => setState(() =>
                                _activeMenu = _activeMenu == 'quality'
                                    ? null
                                    : 'quality'),
                            menu: _activeMenu == 'quality'
                                ? _PopupMenu(
                          ...
                          _MenuBtn(
                            ...
                            onTap: () => setState(() =>
                                _activeMenu = _activeMenu == 'audio'
                                    ? null
                                    : 'audio'),
                            menu: _activeMenu == 'audio'
                                ? _PopupMenu(
                          ...
                          _MenuBtn(
                            ...
                            onTap: () => setState(() =>
                                _activeMenu = _activeMenu == 'sub'
                                    ? null
                                    : 'sub'),
                            menu: _activeMenu == 'sub'
                                ? _PopupMenu(
...
class _MenuBtn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        if (menu != null)
          Positioned(bottom: 52, left: -40, child: menu!),
        GestureDetector(
          onTap: onTap,
          child: Column(
            mainAxisSize: MainAxisSize.min,
...
class _PopupMenu extends StatelessWidget {
  ...
  const _PopupMenu(
      {required this.items, required this.active, required this.onSelect});
          ...
          return GestureDetector(
            ...
            child: Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                  color:
                      sel ? const Color(0xFFFFCC00) : Colors.white70,
                  fontWeight:
