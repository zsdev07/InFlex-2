              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _DebugRow('Native', state.nativeState.isEmpty
                        ? '—'
                        : '${state.nativeState}'
                            '${state.isPaused ? ' (paused)' : ''}'
                            '${state.queuePosition >= 0 ? ' q${state.queuePosition}' : ''}'),
                    _DebugRow('Peers', '${state.peers}  (seeds: ${state.numSeeds})'),
                    _DebugRow('Speed',
                    ...
                    _DebugRow('libtorrent',
                        state.libraryVersion.isEmpty
                            ? '—'
