...
//   2. Displays live buffering state (peers, speed, progress)
...
class _TorrentLoadingScreenState extends State<TorrentLoadingScreen>
  ...
  Widget _buildProgress() {
    if (_state.phase == TorrentPhase.buffering && _state.totalMb > 0) {
      final pct = (_state.bufferedMb / _state.totalMb).clamp(0.0, 1.0);
      return Column(
        children: [
          ClipRRect(
          ...
          RichText(
            text: TextSpan(
              ...
              children: [
                TextSpan(
                  text:
                      '${_state.bufferedMb.toStringAsFixed(1)} MB',
                  style: const TextStyle(
                ...
                TextSpan(
                  text:
                      '${_state.totalMb.toStringAsFixed(0)} MB',
